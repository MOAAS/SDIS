...
|  Running  |
+-----------+
For running the Peers on vanilla and enhanced versions, respectively:

java PeerRunner 1.0 <peerID> <RMIaccessPoint> <MCAddress> <MCPort> <MDBAddress> <MDBPort> <MDRAddress> <MDRPort>
java PeerRunner 1.1 <peerID> <RMIaccessPoint> <MCAddress> <MCPort> <MDBAddress> <MDBPort> <MDRAddress> <MDRPort>
